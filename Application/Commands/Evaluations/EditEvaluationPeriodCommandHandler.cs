...
{
    public class EditEvaluationPeriodCommandHandler : IRequestHandler<EditEvaluationPeriodCommand, EvaluationPeriod>
    {
        ...
        public async Task<EvaluationPeriod> Handle(EditEvaluationPeriodCommand request, CancellationToken cancellationToken)
        {
    ...
    public record EditEvaluationPeriodCommand(long Id, DateOnly StartDate, DateOnly EndDate, string Name, string Description) : IRequest<EvaluationPeriod>;
}
